                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input type="text" id="phone" name="phone" size="46" placeholder="10 Digits phone number"/>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" id="state" name="state" size="46" placeholder="Example: NY"/>
                            </td>
                            <td>
                                <label>Zip code:<span style={star}>*</span></label><br/>
                                <input type="text" id="zip" name="zip" size="46" placeholder="5 dights zip code"/>
                            </td>
                        </tr>
                        <tr>
                            <td colSpan="3">
